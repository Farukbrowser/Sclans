...
# Fetch IP information and other details
izinsc="https://raw.githubusercontent.com/Farukbrowser/Sclans/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Farukbrowser/Sclans/main/"
start=$(date +%s)
secs_to_human() {
...
function udp_mini() {
  ...
  wget raw.githubusercontent.com/Farukbrowser/Sclans/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
  cd
